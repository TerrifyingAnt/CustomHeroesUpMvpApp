...
import jg.coursework.customheroesapp.ui.theme.CustomHeroesBlue
    ...
    Column(
        ...
        OutlinedTextField(
            modifier = Modifier
                ...
                .padding(top = 3.dp)
                .height(60.dp),
            label = { Text(text = description, color = CustomHeroesGray) },
            value = textValue,
            colors = TextFieldDefaults.textFieldColors(
                containerColor = Color.White,
                cursorColor = cursorColor,
                focusedIndicatorColor = CustomHeroesOrange,
                unfocusedIndicatorColor = CustomHeroesGray
            ),
